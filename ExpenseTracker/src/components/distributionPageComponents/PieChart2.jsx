    ...
    <section className="relative flex h-[620px] pt-4 flex-grow">
      {filteredData != null ? (
        <>
          ...
          filteredData[0].name === "Outgoing" &&
          filteredData[0].subFields.length != 0 ? (
            <div className="flex relative justify-center items-center flex-grow mt-4">
              ...
              {stage != null ? (
                <div className="flex absolute bottom-[-5px] right-[50%] translate-x-[50%]">
                  <span>{outgoingTransactionCategories[stage.ind].name}</span>
                </div>
              ) : null}
              ...
              {stage === null ? (
                <PieChart width={600} height={600} className="">
                  ...
                  <Pie
                    ...
                    labelLine={false}
                  >
                    {filteredData[0].subFields.map((entry, index) => {
                      return (
                        <Cell
                          stroke="#000"
                          strokeWidth={1}
                ...
                <PieChart width={600} height={600} className="">
                  ...
                  <Tooltip filterNull wrapperClassName="hidden" />
                  <Pie
                    data={filteredData[0].subFields[stage.ind].subFields}
                    paddingAngle={3}
                    dataKey="value"
                    nameKey="name"
                    cx="50%"
                    ...
                    labelLine={false}
                  >
                    {filteredData[0].subFields[stage.ind].subFields.map(
                      (entry, index) => {
                        return (
                          <Cell
                            stroke="#000"
